...
export default function LoadingState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-3xl border border-equi-300/50 bg-equi-50 p-8 text-center dark:border-equi-800/50 dark:bg-equi-950">
